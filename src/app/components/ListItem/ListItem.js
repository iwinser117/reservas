                ...
                <div className="flex flex-col col-span-6 md:col-span-8">
                  <div className="flex justify-between items-start">
                    <div className="flex flex-col gap-0 relative w-full">
                      <h3 className="font-semibold text-foreground/90">
                        {item.name}
                        <div className="absolute top-0 right-0 flex items-center text-small text-foreground/50">
                          {item.rating}
                  ...
                  <div className="flex w-full items-center justify-end gap-2">
                    <Button
                      ...
                      radius="full"
                      variant="light"
                      onPress={() => toggleLiked(itemId)}
                      aria-label="Agregar a favoritos"
                    >
                      <HeartIcon
                        className={
                          likedItems[itemId] ? "[&>path]:stroke-transparent" : ""
                        }
                        fill={likedItems[itemId] ? "red" : "none"}
                      />
                    </Button>
